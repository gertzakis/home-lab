source "proxmox-iso" "ubuntu-24_04" {
  ...
  node                 = "proxmox-01"
  vm_id                = "90104"
  vm_name              = "ubuntu-k8s-24-04-tmpl-01.home.lab"
  template_description = "A Ubuntu 24.04 cloud-init enabled template, ready for Kubernetes 1.32."
  ...
  additional_iso_files {
    ...
    cd_files = [
      "./ubuntu-k8s-24_04/http/meta-data",
      "./ubuntu-k8s-24_04/http/user-data"
    ]
    cd_label = "cidata"
  }
...
build {
  ...
  provisioner "file" {
    source      = "ubuntu-k8s-24_04/files/99-pve.cfg"
